...
impl Glyph {
    const fn asset_path(self) -> &'static str {
        match self {
            ...
            Self::HidePanel => "icons/ui/hide-panel.svg",
            Self::Join => "icons/ui/join.svg",
            Self::Pencil => "icons/ui/pencil.svg",
            Self::Port => "icons/ui/port.svg",
            Self::Prompt => "icons/ui/prompt.svg",
            Self::Refresh => "icons/ui/refresh.svg",
            Self::Send => "icons/ui/send.svg",
            Self::ShowPanel => "icons/ui/show-panel.svg",
...
const GLYPHS: &[(&str, &[u8])] = &[
    ...
    (
        "icons/ui/hide-panel.svg",
        include_bytes!("../assets/icons/ui/hide-panel.svg"),
    ),
    (
        "icons/ui/join.svg",
        include_bytes!("../assets/icons/ui/join.svg"),
    ),
    (
        "icons/ui/pencil.svg",
    ...
    (
        "icons/ui/prompt.svg",
        include_bytes!("../assets/icons/ui/prompt.svg"),
    ),
    (
    ...
    (
        "icons/ui/show-panel.svg",
        include_bytes!("../assets/icons/ui/show-panel.svg"),
    ),
    (
        "icons/ui/split.svg",
